...
class Cage:
    ...
    def displace_cages(self, arene_smile,diamine_smile,sym,metal_atom):
        ...
        vecs_vertex = Cage.cage_vertex_vec(self, diamine_smile) #this has all the vectors of the arene to centroid
        ...
        list_wa, list_ww, list_aa, list_wv = Cage.generate_new_cages(self, guest_bb_aa, guest_bb_ww, guest_bb_wa, guest_bb_wv, vec_w, vec_a, rotated_vectors_w, rotated_vectors_a, dist)
        ...
        fixed_atom_set = Cage.fix_atom_set(rdkit_mol, diamine_smile, metal_atom=metal_atom)
